...
--Indeks Unikalny_Mecz zapewniający unikalność kombinacji daty i 2 zespołów dla kazdego meczu
CREATE UNIQUE INDEX Unikalny_Mecz ON Mecz(Data_Meczu, Klub_Gospodarz, Klub_Gosc);
--Indeks zapewniający unikalność stadionu dla kazdego klubu
CREATE UNIQUE INDEX Index_nazwa_stadionu ON Klub(Nazwa_Stadionu);
